...
export const blogPosts: BlogPost[] = [
    ...
    },
   {
        ...
        content: `<p>The Coffee Triangle (Eje Cafetero) is a UNESCO World Heritage Site that invites you to embark on a sensory journey unlike any other. This region, nestled in the foothills of the Andes, is renowned for its lush coffee plantations, picturesque towns, and the warm hospitality of its people.</p><h2>Aromatic Awakening</h2><p>Begin your journey by immersing yourself in the intoxicating aroma of freshly roasted coffee beans. Visit a traditional coffee farm (finca) and learn about the meticulous process of cultivating, harvesting, and processing the beans. Breathe in the rich, earthy scent as you walk through the green fields, and witness the traditional methods handed down through generations.</p><h2>Visual Feast</h2><p>Prepare for a visual feast as you explore the rolling hills and stunning landscapes of the Coffee Triangle. Quindío, Caldas, and Risaralda are dotted with charming towns boasting colorful architecture, vibrant plazas, and panoramic vistas. Wander through the streets of Salento, with its iconic wax palms framing the horizon, or marvel at the breathtaking views from the mountaintop town of Filandia.</p><h2>Tastes of Tradition</h2><p>Indulge in the authentic flavors of Colombian cuisine, sampling local specialties that complement the coffee experience. Savor the traditional bandeja paisa, a hearty platter of beans, rice, meat, and fried plantains, or treat yourself to a sweet arequipe (dulce de leche) made with locally sourced milk. And, of course, no visit to the Coffee Triangle is complete without savoring a cup of freshly brewed Colombian coffee, prepared with expertise and passion.</p><h2>Soundscapes of the Andes</h2><p>Listen to the sounds of the Colombian countryside as you immerse yourself in the local culture. Enjoy the lively rhythms of vallenato music, played on accordions and traditional instruments, and engage in conversations with the welcoming locals, eager to share their stories and traditions. Visit a traditional fair or festival to experience the true spirit of the Coffee Triangle.</p><h2>Embrace the Texture</h2><p>Feel the warmth of the sun on your skin as you hike through the verdant hills, and the smooth texture of a perfectly roasted coffee bean in your hand. Connect with the earth as you explore the coffee plantations and learn about the region\'s dedication to sustainable farming practices. The Coffee Triangle offers a tactile experience that will leave you feeling refreshed and revitalized.</p><p>Exploring the Coffee Triangle is an invitation to awaken your senses and discover the magic of Colombia\'s coffee culture. From the aromatic beans to the stunning landscapes and vibrant traditions, this journey will leave you with a lasting appreciation for this remarkable region and its people.</p>`,        image: getAssetPath('/images/blog-coffee-sensory.png'),
        author: 'Bukaro',
        date: '2026-03-05',
