...
const citiesToVerify = [
    { name: 'Yaguará', dept: 'Huila' },
    { name: 'Isnos', dept: 'Huila' },
    { name: 'La Guadalupe', dept: 'Guainía' },
    { name: 'Cacahual', dept: 'Guainía' },
    { name: 'Pana Pana', dept: 'Guainía' },
    { name: 'Morichal', dept: 'Guainía' }
];

console.log('--- Final City Data Verification ---');
