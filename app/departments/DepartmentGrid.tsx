                ...
                <div className="mb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredDepartments.map((dept) => {
                            ...
                            // Specific mappings
                            if (name.includes('Amazonas')) imagePath = '/images/departments/amazonas.png';
                            else if (name.includes('Antioquia')) imagePath = '/images/departments/antioquia.png';
                            else if (name.includes('Arauca')) imagePath = '/images/departments/arauca.png';
                            else if (name.includes('Atlantico')) imagePath = '/images/departments/atlantico.png';
                            else if (name.includes('Bolivar')) imagePath = '/images/departments/bolivar.png';
                            else if (name.includes('Boyaca')) imagePath = '/images/departments/boyaca.png';
                            else if (name.includes('Caldas')) imagePath = '/images/departments/caldas.png';
                            else if (name.includes('Caqueta')) imagePath = '/images/departments/caqueta.png';
                            else if (name.includes('Casanare')) imagePath = '/images/departments/casanare.png';
                            else if (name.includes('Cauca') && !name.includes('Valle')) imagePath = '/images/departments/cauca.png';
                            else if (name.includes('Cesar')) imagePath = '/images/departments/cesar.png';
                            else if (name.includes('Choco')) imagePath = '/images/departments/choco.png';
                            else if (name.includes('Cordoba')) imagePath = '/images/departments/cordoba.png';
                            else if (name.includes('Cundinamarca')) imagePath = '/images/departments/cundinamarca.png';
                            else if (name.includes('Guainia')) imagePath = '/images/departments/guainia.png';
                            else if (name.includes('Guaviare')) imagePath = '/images/departments/guaviare.png';
                            else if (name.includes('Huila')) imagePath = '/images/departments/huila.png';
                            else if (name.includes('Guajira')) imagePath = '/images/departments/guajira.png';
                            else if (name.includes('Magdalena')) imagePath = '/images/departments/magdalena.png';
                            else if (name.includes('Meta')) imagePath = '/images/departments/meta.png';
                            else if (name.includes('Narino')) imagePath = '/images/departments/narino.png';
                            else if (name.includes('Norte de Santander')) imagePath = '/images/departments/norte-santander.png';
                            else if (name.includes('Putumayo')) imagePath = '/images/departments/putumayo.png';
                            else if (name.includes('Quindio')) imagePath = '/images/departments/quindio.png';
                            else if (name.includes('Risaralda')) imagePath = '/images/departments/risaralda.png';
                            else if (name.includes('San Andres')) imagePath = '/images/departments/san-andres.png';
                            else if (name.includes('Santander') && !name.includes('Norte')) imagePath = '/images/departments/santander.png';
                            else if (name.includes('Sucre')) imagePath = '/images/departments/sucre.png';
                            else if (name.includes('Tolima')) imagePath = '/images/departments/tolima.png';
                            else if (name.includes('Valle')) imagePath = '/images/departments/valle-cauca.png';
                            else if (name.includes('Vaupes')) imagePath = '/images/departments/vaupes.png';
                            else if (name.includes('Vichada')) imagePath = '/images/departments/vichada.png';
                            else if (name.includes('Bogota')) imagePath = '/images/cities/cundinamarca/bogota.png';
